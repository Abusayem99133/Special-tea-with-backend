...
const UpdateCoffee = () => {
  ...
  return (
    <div>
      <h1 className="text-5xl text-purple-400 text-center">
        Shope Your Coffee to update: {name}
      </h1>
      <div>
        <h1 className="text-4xl text-purple-700 font-extrabold text-center">
          Update Coffee to your shop
        </h1>
        <form onSubmit={handleUpdateCoffee} className="bg-slate-200 mt-8 p-5">
